...
const getAnswer = async (req, res) => {
  try {
    ...
    if (answer) {
      res
        .status(200)
        .json({ message: "Answer found successfully ", data: answer });
    } else {
...
const getAnswers = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Answer found successfully ", data: answers });
  } catch (error) {
...
const registerAnswer = async (req, res) => {
  try {
    ...
    res
      .status(201)
      .json({ message: "Answer added successfully", data: createdAnswer });
  } catch (error) {
...
const updateAnswer = async (req, res) => {
  try {
    ...
    if (answer) {
      ...
      res
        .status(200)
        .json({ message: "Answer updated successfully", data: updatedAnswer });
    } else {
      res.status(404).json({ message: "Answer not found" });
    }
  } catch (error) {
